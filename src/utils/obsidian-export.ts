...
export const CLIP_CSS_VERSION = 2;
...
mark.hl-yellow { background: rgba(var(--clip-yellow), .28); color: inherit; border-radius: 3px; padding: 0 .15em; }
mark.hl-red { background: rgba(var(--clip-red), .26); color: inherit; border-radius: 3px; padding: 0 .15em; }
mark.hl-green { background: rgba(var(--clip-green), .24); color: inherit; border-radius: 3px; padding: 0 .15em; }
